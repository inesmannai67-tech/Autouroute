    ...
    Column(
        ...
        Column(modifier = Modifier.padding(24.dp)) {
            ...
            if (isLoading) {
                ...
                PrimaryButton(text = Strings.VALIDER, onClick = {
                    if (phone.isEmpty()) {
                    ...
                    coroutineScope.launch {
                        ...
                        if (success) {
                            Toast.makeText(context, "Le code d'authentification a été envoyé au $phone (OTP de test: $message)", Toast.LENGTH_LONG).show()
                            onAuthRequest(phone)
                        } else {
